.. _E_Generating-and-launching-a-schedule: 
...
Notice: the projectID written inside the SCD schedule file MUST coincide with 
the project in use during observations. 
